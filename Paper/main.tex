...
\begin{proof}
  ...
  %   \begin{equation}
  %     \begin{split}
  %       & \forall{a \in (C \uplus \{e\}) \cup I} ~.~ G.\lLAB(a) = S.\lLAB(\lf(a)) \iff \\
  %       & \forall{a \in C \cup I} ~.~
  %         G.\lLAB(a) = S.\lLAB(\lf(a)) \wedge G.\lLAB(e) = S.\lLAB(\lf(e))
  %     \end{split}
  %   \end{equation}
...
\begin{proof}
  ...
  \begin{itemize}
    ...
    \item $e \in G.\lW$ \\
      ...
      Let us show that $\tup{e, \lf(e)} \in \forward(S, G, \tup{C, I}, \lf)$.
      \begin{itemize}
  ...
  Suppose there exists $\hat{e} \in S.\lE$ s.t. $\tup{\lf(c), \hat{e}} \in S.\lPO_{imm}$.
...
\begin{lemma}
  Given $S$, $G$, $\tup{C, I}$, $\lf$, $\Prog$ and $\Execs{\Prog}$
  s.t. $\Execs{\Prog} \vdash G$ and $\simR(S, G, \tup{C, I}, \lf)$ hold
