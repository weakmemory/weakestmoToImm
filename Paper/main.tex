...
\small
    ...
    \AxiomC{$\lTID' = \lTID[\hat{e} \mapsto \lG.\lTID(e)]$}
    \noLine
    \UnaryInfC{$\lLAB' = \lLAB[\hat{e} \mapsto \lG.\lLAB(e)]$}
    \noLine
    \UnaryInfC{$\lMOD' = \lMOD[\hat{e} \mapsto \lG.\lMOD(e)]$}

    \AxiomC{$\lPO' = \lPO \cup s(G.\lPO;[e])$}

    \TrinaryInfC{$
      \lG \vdash (s, t, \tup{\lE, \lTID, \lLAB, \lMOD}, \lPO)
      \ESbasicstep{e}
...
\small
    ...
    \begin{center}
      ...
      \UnaryInfC{$
        \lG \vdash \tup{s, t, \lES_{base}, \lPO, \lRMW, \lRF, \lEW, \lMO}
        \ESstep{e}
    ...
    \begin{center}
      ...
      \noLine
      \UnaryInfC{$
        \lG \vdash (s, t, \lES_{base}, \lPO)
        \ESbasicstep{e}
        (s', t', \lES'_{base}, \lPO')
      $}

      \AxiomC{$\lRF' = \lRF \cup \{\tup{s'(w), s'(e)} ~|~ \tup{w, e} \in \lG.\lRF \}$}
...
%%   \begin{itemize}
%%   \item $\lE.\lE = \lMC(C')$
%%   \item $\lE.\lPO = \lMC([\lC'];\lG.\lPO;[\lC'])$
%%   \item $\lE.\lRMW = \lMC([\lC'];\lG.\lRMW;[\lC'])$
%%   \item $\lE.\lRF = \lMC([\lC'];\lG.\lRF;[\lC'])$
%%   \item $\lE.\lMO = \lMC([\lC'];\lG.\lMO;[\lC'])$    
%%   \end{itemize}
%% \end{lemma}
