...
\small
    ...
    \noLine
    \UnaryInfC{$s' = s[e \mapsto \hat{e}]$}
    \noLine
    \UnaryInfC{$t' = t[\hat{e} \mapsto e]$}

    \AxiomC{$\lTID' = \lTID[\hat{e} \mapsto G.\lTID(e)]$}
    \noLine
    \UnaryInfC{$\lLAB' = \lLAB[\hat{e} \mapsto G.\lLAB(e)]$}
    \noLine
    \UnaryInfC{$\lMOD' = \lMOD[\hat{e} \mapsto G.\lMOD(e)]$}

    \AxiomC{$\lPO' = \lPO \cup s(G.\lPO;[e])$}

    \TrinaryInfC{$
      G \vdash (s, t, \tup{\lE, \lTID, \lLAB, \lMOD}, \lPO)
      \ESbasicstep{e}
      (s', t', \tup{\lE', \lTID', \lLAB', \lMOD'}, \lPO')
    $}
    \DisplayProof
    \end{center}
...
\small
    ...
    \begin{center}
      ...
      \AxiomC{$e \in G.\lF^{\sqsubset\sco}$}
      \noLine
      \UnaryInfC{$
        G \vdash (\lM, \lES_{base})
        \ESbasicstep{e}
        (\lM', \lES'_{base})
      $}

      \UnaryInfC{$
        G \vdash \tup{s, t, \lES_{base}, \lPO, \lRMW, \lRF, \lEW, \lMO}
        \ESstep{e}
        \tup{s', t', \lES'_{base}, \lPO', \lRMW, \lRF, \lEW, \lMO}
      $}
      \DisplayProof
      
    \end{center}
    \label{fig:esstep-fence}
    \end{subfigure}
    ...
    \begin{center}
      ...
      \noLine
      \UnaryInfC{$
        G \vdash (s, t, \lES_{base}, \lPO)
        \ESbasicstep{e}
        (s', t', \lES'_{base}, \lPO')
      $}

      \AxiomC{$\lRF' = \lRF \cup \{\tup{s'(w), s'(e)} ~|~ \tup{w, e} \in G.\lRF \}$}
    ...
    \begin{center}
      ...
      \AxiomC{$\lMO' = \lMO \cup s'(G.\lMO;[e])$}
      \noLine
      \UnaryInfC{$\lEW' = (\lEW \cup \tup{s(e), s'(e)})^{+=}$}
