...
\small
    ...
    \AxiomC{$\lPO' = \lPO \cup \lM([\lC];\lG.\lPO;[e])$}

    \TrinaryInfC{$
      \lG \vdash (\lM, \tup{\lE, \lTID, \lLAB, \lMOD, \lPO, \lRMW})
      \lBASICSTEP{e}
      (\lM', \tup{\lE', \lTID', \lLAB', \lMOD', \lPO', \lRMW})
    $}
    \DisplayProof
    \end{center}
...
\small
    ...
    \begin{center}
      ...
      \BinaryInfC{$
        \lG \vdash \tup{\lM, \lES_{base}, \lRF, \lEW, \lMO}
        \lCOVERSTEP{e}
        \tup{\lM', \lES'_{base}, \lRF, \lEW, \lMO}
        $}
      \DisplayProof
    \end{center}
    ...
    \begin{center}
      ...
      \BinaryInfC{$
        (\lG, \tup{\lC, \lI}) \vdash 
        \tup{\lM, \lES_{base}, \lPO, \lRMW, \lRF, \lEW, \lMO}
        \lCOVERSTEP{e}
    ...
    \begin{center}
      ...
      \AxiomC{$e \in \dom{m} \wedge \lG.\lLAB(e) = \lES.\lLAB(\lM(e))$}

      \UnaryInfC{$
        (\lG, \tup{\lC, \lI}) \vdash
        \tup{\lM, \lES_{base}, \lRF, \lEW, \lMO}
        \lCOVERSTEP{e}
        \tup{\lM, \lES_{base}, \lRF, \lEW, \lMO}
        $}
      \DisplayProof
    \end{center}
    \label{fig:simrule-cover-skip}
    \end{subfigure}
