  ...
  \begin{enumerate}[label=\textbf{S.\arabic*}]
    ...
    \item \label{item:sim-vis} 
      ...
      \note{I am afraid that we cannot prove this.
        ...
        Instead I propose to use \ref{lem:2}.
      }
...
%%    \AxiomC{$\lPO' = \lPO \cup \lE_i \times \{\hat{e}\}$}
    ...
    \BinaryInfC{$
      \tup{\lE, \lTID, \lLAB, \lMOD}
      \xRightarrow{\lG, e}
      (\hat{e}, \tup{\lE', \lTID', \lLAB', \lMOD'})
    $}
    \DisplayProof
    \end{center}
...
\small
    ...
    [COVER-FENCE]
    \begin{center}
      \AxiomC{$\lES_{base} \xRightarrow{\lG, e} (\hat{e}, \lES'_{base})$}
      \noLine
      \UnaryInfC{$\lMC' = \lMC[e \rightarrow \hat{e}]$}
      \noLine
    ...
    \begin{center}
      ...
      \noLine
      \UnaryInfC{$\lEW' = \lEW \cup \{\tup{\hat{e}, \lMI(e)}, \tup{\lMI(e), \hat{e}}\}$}
      \BinaryInfC{$
        \tup{\lMC, \lMI, \lES_{base}, \lPO, \lRMW, \lRF, \lEW, \lMO}
        \xrightarrow{\lG, \lC, \lI, e}
        \tup{\lMC', \lMI, \lES_{base}, \lPO', \lRMW, \lRF, \lEW', \lMO'}
    ...
    \begin{center}
      ...
      \AxiomC{$\lPO' = \lPO \cup \lMC'([\lC];\lG.\lPO;[e])$}
      \noLine
      \UnaryInfC{$\lRF' = \lRF \cup \{\tup{\lMI(w), \hat{e}} ~|~ \tup{w, e} \in \lG.\lRF \} $}
      \BinaryInfC{$
        \tup{\lMC, \lMI, \lES_{base}, \lPO, \lRMW, \lRF, \lEW, \lMO}
        \xrightarrow{\lG, \lC, \lI, e}
        \tup{\lMC', \lMI, \lES_{base}, \lPO', \lRMW, \lRF', \lEW, \lMO}
