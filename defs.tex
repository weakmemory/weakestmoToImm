...
\newcommand{\lBASICSTEP}[1]{\xLongrightarrow{#1}}
\newcommand{\lCOVERSTEP}[1]{\xlongrightarrow{#1}_{\lC}}
...
\newcommand{\rlabExExpl}[3]{\lR^{#3}({#1},{#2})}
\newcommand{\rlabEx}[2]{\rlabExExpl{#1}{#2}{\Ex}}
